...
/// </summary>
public class PrintingGravurePrintUnit14(DateTime? queryTimestamp, string machineId)
{
    ...
    public NumericSnapshotValue Viscosity()
        => new(SnapshotColumnIds.PrintingGravureUnit14ActualValuesViscosity, _queryTimestamp, _machineId);
    ...
    public NumericSnapshotValue ESADischargeState()
        => new(SnapshotColumnIds.PrintingGravureUnit14ESAActualValuesDischargeStatus, _queryTimestamp, _machineId);
    ...
    public NumericSnapshotValue ESAChargeState()
        => new(SnapshotColumnIds.PrintingGravureUnit14ESAActualValuesChargeStatus, _queryTimestamp, _machineId);
    ...
    public NumericSnapshotValue ESAChargeCurrent()
        => new(SnapshotColumnIds.PrintingGravureUnit14ESAActualValuesChargeCurrent, _queryTimestamp, _machineId);
    ...
    public NumericSnapshotValue Drying1Temperature()
        => new(SnapshotColumnIds.PrintingGravureUnit14Drying1ActualValuesTemperature, _queryTimestamp, _machineId);
    ...
    public NumericSnapshotValue Drying2Temperature()
        => new(SnapshotColumnIds.PrintingGravureUnit14Drying2ActualValuesTemperature, _queryTimestamp, _machineId);
    ...
    public NumericSnapshotValue Drying3Temperature()
        => new(SnapshotColumnIds.PrintingGravureUnit14Drying3ActualValuesTemperature, _queryTimestamp, _machineId);
    ...
    public NumericSnapshotValue Drying4Temperature()
        => new(SnapshotColumnIds.PrintingGravureUnit14Drying4ActualValuesTemperature, _queryTimestamp, _machineId);
}