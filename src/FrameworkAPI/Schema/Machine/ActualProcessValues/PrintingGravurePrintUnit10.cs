...
/// </summary>
public class PrintingGravurePrintUnit10(DateTime? queryTimestamp, string machineId)
{
    ...
    public NumericSnapshotValue Viscosity()
        => new(SnapshotColumnIds.PrintingGravureUnit10ActualValuesViscosity, _queryTimestamp, _machineId);
    ...
    public NumericSnapshotValue ESADischargeState()
        => new(SnapshotColumnIds.PrintingGravureUnit10ESAActualValuesDischargeStatus, _queryTimestamp, _machineId);
    ...
    public NumericSnapshotValue ESAChargeState()
        => new(SnapshotColumnIds.PrintingGravureUnit10ESAActualValuesChargeStatus, _queryTimestamp, _machineId);
    ...
    public NumericSnapshotValue ESAChargeCurrent()
        => new(SnapshotColumnIds.PrintingGravureUnit10ESAActualValuesChargeCurrent, _queryTimestamp, _machineId);
    ...
    public NumericSnapshotValue Drying1Temperature()
        => new(SnapshotColumnIds.PrintingGravureUnit10Drying1ActualValuesTemperature, _queryTimestamp, _machineId);
    ...
    public NumericSnapshotValue Drying2Temperature()
        => new(SnapshotColumnIds.PrintingGravureUnit10Drying2ActualValuesTemperature, _queryTimestamp, _machineId);
    ...
    public NumericSnapshotValue Drying3Temperature()
        => new(SnapshotColumnIds.PrintingGravureUnit10Drying3ActualValuesTemperature, _queryTimestamp, _machineId);
    ...
    public NumericSnapshotValue Drying4Temperature()
        => new(SnapshotColumnIds.PrintingGravureUnit10Drying4ActualValuesTemperature, _queryTimestamp, _machineId);
}