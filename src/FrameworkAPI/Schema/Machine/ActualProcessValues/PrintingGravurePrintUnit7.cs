...
/// </summary>
public class PrintingGravurePrintUnit7(DateTime? queryTimestamp, string machineId)
{
    ...
    public NumericSnapshotValue Viscosity()
        => new(SnapshotColumnIds.PrintingGravureUnit7ActualValuesViscosity, _queryTimestamp, _machineId);
    ...
    public NumericSnapshotValue ESADischargeState()
        => new(SnapshotColumnIds.PrintingGravureUnit7ESAActualValuesDischargeStatus, _queryTimestamp, _machineId);
    ...
    public NumericSnapshotValue ESAChargeState()
        => new(SnapshotColumnIds.PrintingGravureUnit7ESAActualValuesChargeStatus, _queryTimestamp, _machineId);
    ...
    public NumericSnapshotValue ESAChargeCurrent()
        => new(SnapshotColumnIds.PrintingGravureUnit7ESAActualValuesChargeCurrent, _queryTimestamp, _machineId);
    ...
    public NumericSnapshotValue Drying1Temperature()
        => new(SnapshotColumnIds.PrintingGravureUnit7Drying1ActualValuesTemperature, _queryTimestamp, _machineId);
    ...
    public NumericSnapshotValue Drying2Temperature()
        => new(SnapshotColumnIds.PrintingGravureUnit7Drying2ActualValuesTemperature, _queryTimestamp, _machineId);
    ...
    public NumericSnapshotValue Drying3Temperature()
        => new(SnapshotColumnIds.PrintingGravureUnit7Drying3ActualValuesTemperature, _queryTimestamp, _machineId);
    ...
    public NumericSnapshotValue Drying4Temperature()
        => new(SnapshotColumnIds.PrintingGravureUnit7Drying4ActualValuesTemperature, _queryTimestamp, _machineId);
}