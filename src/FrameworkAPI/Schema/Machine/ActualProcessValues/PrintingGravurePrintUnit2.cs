...
/// </summary>
public class PrintingGravurePrintUnit2(DateTime? queryTimestamp, string machineId)
{
    ...
    public NumericSnapshotValue Viscosity()
        => new(SnapshotColumnIds.PrintingGravureUnit2ActualValuesViscosity, _queryTimestamp, _machineId);
    ...
    public NumericSnapshotValue ESADischargeState()
        => new(SnapshotColumnIds.PrintingGravureUnit2ESAActualValuesDischargeStatus, _queryTimestamp, _machineId);
    ...
    public NumericSnapshotValue ESAChargeState()
        => new(SnapshotColumnIds.PrintingGravureUnit2ESAActualValuesChargeStatus, _queryTimestamp, _machineId);
    ...
    public NumericSnapshotValue ESAChargeCurrent()
        => new(SnapshotColumnIds.PrintingGravureUnit2ESAActualValuesChargeCurrent, _queryTimestamp, _machineId);
    ...
    public NumericSnapshotValue Drying1Temperature()
        => new(SnapshotColumnIds.PrintingGravureUnit2Drying1ActualValuesTemperature, _queryTimestamp, _machineId);
    ...
    public NumericSnapshotValue Drying2Temperature()
        => new(SnapshotColumnIds.PrintingGravureUnit2Drying2ActualValuesTemperature, _queryTimestamp, _machineId);
    ...
    public NumericSnapshotValue Drying3Temperature()
        => new(SnapshotColumnIds.PrintingGravureUnit2Drying3ActualValuesTemperature, _queryTimestamp, _machineId);
    ...
    public NumericSnapshotValue Drying4Temperature()
        => new(SnapshotColumnIds.PrintingGravureUnit2Drying4ActualValuesTemperature, _queryTimestamp, _machineId);
}