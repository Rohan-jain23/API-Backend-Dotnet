...
public class SnapshotValue<T>(string columnId, DateTime? queryTimestamp, string machineId)
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        return snapshotResult.Value?.ColumnValue is null ? default(T) : (T?)(snapshotResult.Value.ColumnValue);
    }
