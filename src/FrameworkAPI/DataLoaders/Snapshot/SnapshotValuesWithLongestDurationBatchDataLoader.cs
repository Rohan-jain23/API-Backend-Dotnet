...
public class SnapshotValuesWithLongestDurationBatchDataLoader : BatchDataLoader<SnapshotValueRequestKey, DataResult<object?>>
{
    private readonly IMachineSnapshotHttpClient _machineSnapshotHttpClient;

    public SnapshotValuesWithLongestDurationBatchDataLoader(
    ...
    protected override async Task<IReadOnlyDictionary<SnapshotValueRequestKey, DataResult<object?>>> LoadBatchAsync(
        ...
        CancellationToken cancellationToken)
    {
        ...
        var snapshotClientResponseTasks = batches
            .Select(async group =>
            {
                ...
                var response = await _machineSnapshotHttpClient.GetValuesWithLongestDuration(
                    machineId,
